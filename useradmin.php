...
<?php require_once("_nav.php"); ?>
    <main>
        ...
        <form action="useradmin.php" method="POST">
            ...
            <div class="user_data"><?=$id?>$nbsp;$nbsp;$user_data['username']<br>$user_data['password']<br>$user_data['created']</div>
            ...
            <label for="userlevel">User level: (10-299:user, 300-999:power user, 1000-9999:admin, >10,000:superuser)</label>
            ...
            while($row=mysqli_fetch_assoc($result)): ?>
                ...
                <details>
                    ...
                    <div class="userdetails">
                        ...
                        <div class="level">&nbsp Level: <?=$row['userlevel'];?></div>
                    </div>
                    ...
                    <div class="buttons">
                        ...
                        <a href="useradmin.php?del=<?=$row['id'];?>">Assasinate</a>
                    </div>
                </details>
